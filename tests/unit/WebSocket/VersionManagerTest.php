...
class VersionManagerTest extends \PHPUnit\Framework\TestCase {
    ...
    public function testYesIsVersionEnabled() {
        ...
        $this->assertTrue($this->vm->isVersionEnabled(new Request('get', '/', array(
            'Host' => 'socketo.me'
          , 'Sec-WebSocket-Version' => 13
        ))));
    }
    ...
    public function testNoIsVersionEnabled() {
        $this->assertFalse($this->vm->isVersionEnabled(new Request('get', '/', array(
            'Host' => 'socketo.me'
