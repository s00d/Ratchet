...
class TopicManagerTest extends \PHPUnit\Framework\TestCase {
    ...
    public function setUp():void {
        $this->conn = $this->createMock(\Ratchet\ConnectionInterface::class);
        $this->mock = $this->createMock(\Ratchet\Wamp\WampServerInterface::class);
    ...
    public function testGetSubProtocolsBubbles() {
        ...
        $app  = $this->createMock(\Ratchet\Wamp\Stub\WsWampServerInterface::class);
